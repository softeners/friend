    ...
    <div class="container">
      ...
      <div class="grid grid--sidebar">
        <div class="prose">
          ...
          <p class="lead">
            Молодых авторов, которые живут в одном из семи регионов маршрута и хотят
        ...
        <div class="paper paper--right">
          <span class="paper__label">Семь регионов маршрута</span>
          <p>Республика Бурятия, Республика Карелия, Приморский край, Республика Дагестан,
             Северная Осетия — Алания, Республика Алтай, Кемеровская область.</p>
    ...
    <div class="container">
      <div class="grid grid--sidebar">
        ...
        <aside class="aside">
          ...
          <div class="card">
            <h2 class="card__title">Только семь регионов</h2>
            <p class="card__text">
              Бурятия, Карелия, Приморье, Дагестан, Северная Осетия, Республика Алтай
              и Кемеровская область. В экспедицию едут те, кто здесь живёт.
            </p>
          </div>
...
ZINES = page(
    ...
    description='Пилотный зин проекта «Друг» — компиляция материалов семи регионов. '
    ...
    <div class="container">
      <div class="news">
        ...
        <article class="news__item">
          ...
          <div class="news__body">
            <h2 class="news__title">Экспедиции в семь регионов</h2>
            <p class="text">
              Основная экспедиционная цепочка проходит через Республику Алтай, Бурятию,
              Приморский край, Карелию, Дагестан и Северную Осетию. Отдельным зимним выездом
              запланирована Кемеровская область.
            </p>
          </div>
        </article>
        ...
        <article class="news__item">
          ...
          <div class="news__body">
            <h2 class="news__title">Семь выпусков, зин и архив</h2>
            <p class="text">
              К концу этапа будут готовы методика в виде гайда, чек-листов и банка
              вопросов, семь цифровых выпусков, пилотный зин, медиаархив и этот
              сайт-платформа.
            </p>
          </div>
        </article>
    ...
    <div class="container">
      <div class="contact-grid">
        ...
        <a class="contact-card contact-card--accent" href="expedition.html">
          ...
          <span class="contact-card__note">Для молодых авторов из семи регионов маршрута</span>
        </a>
      </div>
    </div>
  </section>
